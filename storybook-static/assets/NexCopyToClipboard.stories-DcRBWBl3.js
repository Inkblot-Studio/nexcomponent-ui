import{R as m}from"./index-CTjT7uj6.js";import{F as M}from"./index.es-D6nAsfRb.js";import{f as U}from"./index-C6Ip3LZi.js";import"./index-BzjuzjN8.js";const y=({className:l,size:j="normal",type:B,textToCopy:G})=>{const H=r=>r&&["primary","secondary","tertiary","quaternary","success","info","warning","danger"].includes(r)?`nex-copy-to-clipboard--${r}`:"",J=r=>r?`nex-copy-to-clipboard--${r}`:"",K=()=>{navigator.clipboard.writeText(G)},L=`nex-copy-to-clipboard ${l||""} ${H(B)} ${J(j)}`;return m.createElement("button",{className:L,onClick:K},m.createElement(M,{icon:U}))},O=y;try{y.displayName="NexCopyToClipboard",y.__docgenInfo={description:`NexCopyToClipboard component

A button component that copies text to the clipboard when clicked.`,displayName:"NexCopyToClipboard",props:{className:{defaultValue:null,description:"",name:"className",required:!1,type:{name:"string"}},size:{defaultValue:{value:"normal"},description:"",name:"size",required:!1,type:{name:"enum",value:[{value:'"small"'},{value:'"normal"'},{value:'"large"'}]}},type:{defaultValue:null,description:"",name:"type",required:!1,type:{name:"string"}},textToCopy:{defaultValue:null,description:"",name:"textToCopy",required:!0,type:{name:"string"}}}}}catch{}const oe={title:"NexComponent/NexCopyToClipboard",component:O,tags:["autodocs"]},e=l=>m.createElement("div",{style:{margin:"20px"}},m.createElement(O,{...l})),o=e.bind({});o.args={textToCopy:"Text to be copied"};const a=e.bind({});a.args={textToCopy:"Text to be copied",type:"primary"};const t=e.bind({});t.args={textToCopy:"Text to be copied",type:"secondary"};const s=e.bind({});s.args={textToCopy:"Text to be copied",type:"tertiary"};const n=e.bind({});n.args={textToCopy:"Text to be copied",type:"quaternary"};const p=e.bind({});p.args={textToCopy:"Text to be copied",type:"success"};const i=e.bind({});i.args={textToCopy:"Text to be copied",type:"info"};const c=e.bind({});c.args={textToCopy:"Text to be copied",type:"warning"};const d=e.bind({});d.args={textToCopy:"Text to be copied",type:"danger"};var u,g,x;o.parameters={...o.parameters,docs:{...(u=o.parameters)==null?void 0:u.docs,source:{originalSource:`args => <div style={{
  margin: '20px'
}}> \r
  ...
  margin: '20px'
      ...
      <NexCopyToClipboard {...args} />\r
    </div>`,...(W=(R=d.parameters)==null?void 0:R.docs)==null?void 0:W.source}}};const ae=["Default","Primary","Secondary","Tertiary","Quaternary","Success","Info","Warning","Danger"];export{d as Danger,o as Default,i as Info,a as Primary,n as Quaternary,t as Secondary,p as Success,s as Tertiary,c as Warning,ae as __namedExportsOrder,oe as default};
