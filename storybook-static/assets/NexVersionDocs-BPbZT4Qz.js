...
import NexVersion from '@nexcomponent/lib/src/components/NexVersion';\r
\r
...
`,n.jsxs(e.p,{children:[n.jsx(e.code,{children:"NexVersion "}),"can be customized by adjusting the styles defined in the accompanying CSS file (",n.jsx(e.code,{children:"NexVersion.scss"}),"). You can modify the appearance and behavior of the version number display and editing interface to match your application's design requirements."]})]})}function a(r={}){const{wrapper:e}={...s(),...r.components};return e?n.jsx(e,{...r,children:n.jsx(o,{...r})}):o(r)}export{a as default};
