...
`,e.jsxs(n.li,{children:[e.jsx(n.strong,{children:"size:"})," Size of the button. Can be 'small', 'normal', or 'large'. Default is 'normal'."]}),`
...
`,e.jsxs(n.p,{children:[e.jsx(n.code,{children:"NexCopyToClipboard "}),"can be customized by providing different props or styling to achieve the desired appearance and functionality. You can adjust the button type, class name, and styling to match your application's design requirements."]})]})}function a(o={}){const{wrapper:n}={...r(),...o.components};return n?e.jsx(n,{...o,children:e.jsx(t,{...o})}):t(o)}export{a as default};
