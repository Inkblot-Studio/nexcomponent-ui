...
`,n.jsxs(e.p,{children:["For detailed documentation on each component and its props, visit the ",n.jsx(e.a,{href:"https://main--6672d9cb533920c89e299205.chromatic.com",rel:"nofollow",children:"official documentation"}),"."]}),`
...
`]}),`
`,n.jsxs(e.p,{children:["That's it! You're now ready to start using ",n.jsx(e.code,{children:"@nexcomponent/lib"})," in your React application. Happy coding!"]})]})}function c(t={}){const{wrapper:e}={...i(),...t.components};return e?n.jsx(e,{...t,children:n.jsx(o,{...t})}):o(t)}export{c as default};
