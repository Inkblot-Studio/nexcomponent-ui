...
`,e.jsxs(n.li,{children:[e.jsx(n.strong,{children:"Loading Animation:"})," ",e.jsx(n.code,{children:"NexLoader "}),"displays a simple yet customizable loading animation to indicate that content is being loaded or processed."]}),`
`,e.jsxs(n.li,{children:[e.jsx(n.strong,{children:"Customization:"})," You can customize the appearance of the loader by adjusting the size, color, and other styling properties."]}),`
`,e.jsxs(n.li,{children:[e.jsx(n.strong,{children:"Accessibility:"})," The component ensures accessibility standards are met, providing a seamless loading experience for all users."]}),`
`]}),`
