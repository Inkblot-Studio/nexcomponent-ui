...
A component to display alert messages with various types and an optional auto-dismiss feature.`,displayName:"NexAlert",props:{id:{defaultValue:null,description:"",name:"id",required:!0,type:{name:"string"}},type:{defaultValue:{value:"info"},description:"",name:"type",required:!1,type:{name:"enum",value:[{value:'"error"'},{value:'"success"'},{value:'"info"'},{value:'"warning"'}]}},message:{defaultValue:{value:""},description:"",name:"message",required:!1,type:{name:"string"}},timeout:{defaultValue:{value:"0"},description:"",name:"timeout",required:!1,type:{name:"number"}},handleDismiss:{defaultValue:{value:"null"},description:"",name:"handleDismiss",required:!1,type:{name:"(() => void)"}}}}}catch{}try{x.displayName="NexAlertsWrapper",x.__docgenInfo={description:`NexAlertsWrapper component
