...
`,n.jsxs(e.p,{children:[n.jsx(e.code,{children:"NexHeroCard"})," can be customized by providing different props or styling to achieve the desired appearance and functionality. You can adjust the content, layout, and styling to match your application's design requirements. The UI will vary depending on whether a background image is included or not, and the button can be styled using ",n.jsx(e.code,{children:"NexButton"}),"."]})]})}function c(t={}){const{wrapper:e}={...o(),...t.components};return e?n.jsx(e,{...t,children:n.jsx(r,{...t})}):r(t)}export{c as default};
