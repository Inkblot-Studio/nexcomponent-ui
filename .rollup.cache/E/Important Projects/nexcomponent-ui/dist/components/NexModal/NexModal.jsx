 ...
 */
const NexModal = ({ setOpenModal }) => {
    const handleContinue = () => {
        setOpenModal(false);
    };
    return (<div className="nex-modal-wrapper">
      <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }} transition={{ duration: 0.3 }} className="nex-modal-inner-wrapper">
        ...
        <div className="nex-modal-footer">
          ...
          <NexButton onClick={handleContinue} text="Continue" type="primary"/>
        </div>
      </motion.div>
    </div>);
};
export default NexModal;
//# sourceMappingURL=NexModal.jsx.map