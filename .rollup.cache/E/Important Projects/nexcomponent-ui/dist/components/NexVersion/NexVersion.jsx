 ...
 */
const NexVersion = ({ version, handleSave }) => {
    ...
    return (<div className="nex-version-wrapper" ref={wrapperRef}>
      <motion.div className={`nex-version ${isEditing ? 'clicked' : ''}`} onClick={handleClick} initial={{ opacity: 1 }} animate={{ opacity: isEditing ? 0.5 : 1 }} transition={{ duration: 0.3 }}>
        {originalVersion}
      </motion.div>
      {isEditing && (<motion.div className="nex-version-edit-wrapper" initial={{ opacity: 0, x: -20 }} animate={{ opacity: 1, x: 0 }} transition={{ duration: 0.3 }}>
...
//# sourceMappingURL=NexVersion.jsx.map