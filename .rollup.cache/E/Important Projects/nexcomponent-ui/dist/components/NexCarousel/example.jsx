...
const NexCarouselExample = () => {
    ...
    return (<div style={{
      ...
      <div style={{
        ...
        <motion.h1 initial={{ opacity: 0, y: -20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.6 }} style={{
            fontSize: '48px',
            fontWeight: '800',
        ...
        <motion.p initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.6, delay: 0.2 }} style={{
            fontSize: '20px',
        ...
        <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.6, delay: 0.4 }} style={{
            display: 'flex',
            gap: '20px',
      ...
      {/* Main Carousel Demo */}
      <motion.div initial={{ opacity: 0, scale: 0.95 }} animate={{ opacity: 1, scale: 1 }} transition={{ duration: 0.8, delay: 0.6 }} style={{
            maxWidth: '1200px',
            margin: '0 auto 60px auto',
            padding: '40px',
        ...
        <NexCarousel slides={selectedVariant === 'gallery' ? gallerySlides : appleSlides} variant={selectedVariant} size={selectedVariant === 'hero' ? 'xl' : 'lg'} autoPlay={true} autoPlayInterval={4000} pauseOnHover={true} infinite={true} showControls={false} showIndicators={true} showCounter={true} onSlideChange={handleSlideChange} onSlideClick={handleSlideClick}/>
      </motion.div>

      {/* Variant Selector */}
      <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.6, delay: 0.8 }} style={{
            maxWidth: '1200px',
        ...
        <div style={{
          ...
          {variants.map(({ key, label, description }) => (<motion.button key={key} onClick={() => setSelectedVariant(key)} style={{
                padding: '20px',
                borderRadius: '16px',
      ...
      {/* Feature Highlights */}
      <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.6, delay: 1.0 }} style={{
            maxWidth: '1200px',
            margin: '0 auto'
        }}>
        <h3 style={{
