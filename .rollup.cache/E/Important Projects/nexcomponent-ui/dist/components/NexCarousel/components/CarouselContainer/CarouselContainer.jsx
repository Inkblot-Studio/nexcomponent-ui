 ...
 */
const CarouselContainer = ({ children, currentSlide, direction, className }) => {
    ...
    return (<motion.div className={`nex-carousel-container ${className || ''}`} initial={{ opacity: 0 }} animate={{ opacity: 1 }} transition={{
      ...
      <AnimatePresence initial={false} custom={direction} mode="wait">
        <motion.div key={currentSlide} custom={direction} variants={slideVariants} initial="enter" animate="center" exit="exit" className="nex-carousel-slide-wrapper">
