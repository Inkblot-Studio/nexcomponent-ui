...
const FooterContainer = ({ children, variant = 'default', theme = 'auto', className = '' }) => {
    ...
    return (<motion.div className={containerClass} initial="initial" animate="animate" variants={backgroundVariants} style={{
            position: 'relative',
            width: '100%',
      ...
      <motion.div className="nex-footer-background" style={{
            position: 'absolute',
            top: 0,
            left: 0,
            right: 0,
      ...
      <motion.div className="nex-footer-shimmer" style={{
            position: 'absolute',
            top: 0,
            left: '-100%',
            width: '100%',
            ...
            pointerEvents: 'none',
            zIndex: 0
        }} variants={shimmerVariants} animate={{
      ...
      <motion.div className="nex-footer-gradient-overlay" style={{
            position: 'absolute',
            top: 0,
            left: 0,
            right: 0,
      ...
      {/* Main Content Area */}
      <motion.div className="nex-footer-content-wrapper" style={{
            position: 'relative',
            zIndex: 1
        }} variants={{
            initial: { opacity: 0 },
...
//# sourceMappingURL=FooterContainer.jsx.map