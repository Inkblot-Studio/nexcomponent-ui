 ...
 */
const NexCard = ({ title, content, imageUrl, actions, badge, type = 'primary', interactive = false, onClick, elevated = false, className, ...rest }) => {
    ...
    return (<motion.div className={cardClasses} variants={cardVariants} initial="initial" animate="animate" whileHover={interactive ? "hover" : {}} whileTap={interactive ? "tap" : {}} onClick={handleClick} onKeyDown={handleKeyDown} role={interactive ? "button" : undefined} tabIndex={interactive ? 0 : undefined} aria-label={interactive ? title : undefined} {...rest}>
      {/* Hero Image */}
      ...
      {interactive && (<motion.div className="nex-card-ripple" initial={{ scale: 0, opacity: 0 }} whileTap={{
                scale: 2,
                opacity: [0, 0.2, 0],
