 ...
 */
const InputContainer = ({ children, focused = false, error = false, disabled = false, className }) => {
    ...
    return (<motion.div className={containerClasses} variants={containerVariants} initial="initial" animate="animate" whileHover={!disabled ? "focus" : {}} transition={{
...
//# sourceMappingURL=InputContainer.jsx.map