 ...
 */
const NexSimpleTextCard = ({ title, subtitle, border = true, className }) => {
    return (<div className={`nex-simple-text-card-wrapper ${border ? 'border' : ''} ${className ? className : ''}`}>
...
//# sourceMappingURL=NexSimpleTextCard.jsx.map