 ...
 */
export const NexCardExamples: React.FC = () => {
  return (
    <div style={{ 
      padding: '40px', 
      ...
      <section>
        <h2>Basic Card</h2>
        <NexCard
          title="Welcome to NexComponent"
          subtitle="Premium UI Library"
          description="A sophisticated card component with Apple-like design principles and smooth animations."
          elevation="raised"
          size="lg"
        />
      </section>
      ...
      <section>
        ...
        <NexCard
          ...
          description="A beautiful glassmorphic card with backdrop blur effects and transparency."
          variant="glass"
          elevation="hoverable"
          size="lg"
        />
      ...
      <section>
        ...
        <NexCard
          ...
          description="Premium styling with signature accent colors and enhanced shadows for enterprise applications."
          variant="premium"
          elevation="interactive"
          interactive
          size="xl"
      ...
      <section>
        ...
        <NexCard
          ...
          description="This card includes a beautiful hero image with proper aspect ratio handling and overlay effects."
          image={{
      ...
      <section>
        ...
        <NexCard
          ...
          subtitle="Efficient Space Usage"
          description="Content and media are arranged horizontally for better space utilization and visual balance."
          image={{
      ...
      <section>
        ...
        <NexCard
          ...
          description="This card includes action buttons in the footer area for user interactions."
          actions={
      ...
      <section>
        ...
        <div style={{ display: 'flex', flexDirection: 'column', gap: '16px', alignItems: 'center' }}>
          ...
          />
           ...
           description="Maximum size for hero content - now truly extra large with 720px max width and 320px min height"
           size="xl"
           elevation="raised"
         />
        </div>
