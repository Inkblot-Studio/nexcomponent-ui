  ...
  return (
    <div style={{ display: 'flex', flexDirection: 'column', gap: '16px' }}>
      ...
      <NexAlert
        ...
        message="Clean, professional styling with subtle shadows."
        variant="default"
        dismissible
      />
      ...
      <NexAlert
        ...
        type="success"
        title="Glass Variant"
        message="Modern glassmorphic design with backdrop blur effects."
        variant="glass"
        dismissible
      />
      ...
      <NexAlert
        ...
        message="Premium styling with signature accent colors and enhanced shadows."
        variant="premium"
        dismissible
      />
      ...
      <NexAlert
        ...
        message="Subtle, minimal design for clean interfaces."
        variant="minimal"
        dismissible
      />
    </div>
  ...
  return (
    <div style={{ display: 'flex', flexDirection: 'column', gap: '16px' }}>
      ...
      <NexAlert
        ...
        type="info"
        title="Small Alert"
        message="Compact size for tight spaces and toast notifications."
        size="sm"
        variant="glass"
        dismissible
      />
      ...
      <NexAlert
        ...
        type="info"
        title="Medium Alert"
        message="Standard size for most use cases and general notifications."
        size="md"
        variant="default"
        dismissible
      />
      ...
      <NexAlert
        ...
        type="info"
        title="Large Alert"
        message="Generous size for prominent messaging and important announcements."
        size="lg"
        variant="premium"
        dismissible
      />
...
export const RichContentAlerts: React.FC = () => {
  return (
    <div style={{ display: 'flex', flexDirection: 'column', gap: '16px' }}>
      ...
      <NexAlert
        ...
        message="document.pdf has been successfully uploaded to your account"
        description="The file is now available in your documents folder and can be shared with your team members. You can also set permissions and track usage."
        variant="premium"
        size="lg"
        actions={[
          {
      ...
      <NexAlert
        ...
        message="You're running out of storage space on your account"
        description="You have 2.1 GB remaining out of 10 GB total. Consider upgrading your plan or cleaning up unused files to free up space."
        variant="default"
        size="lg"
        actions={[
          {
...
export const AutoDismissExamples: React.FC = () => {
  return (
    <div style={{ display: 'flex', flexDirection: 'column', gap: '16px' }}>
      ...
      <NexAlert
        ...
        message="This alert won't auto-dismiss and requires manual dismissal"
        variant="default"
        size="md"
        persistent
        dismissible
...
export const CustomIconsExamples: React.FC = () => {
  return (
    <div style={{ display: 'flex', flexDirection: 'column', gap: '16px' }}>
      <h2>Custom Icons</h2>
      ...
      <NexAlert
        ...
        message="This alert uses a custom SVG icon"
        icon={
      ...
      <NexAlert
        ...
        message="This alert uses a custom React component as the icon"
        icon={
          <div style={{ 
            width: '20px', 
            height: '20px', 
  ...
  return (
    <div style={{ display: 'flex', flexDirection: 'column', gap: '16px' }}>
      ...
      <div style={{ display: 'flex', flexDirection: 'column', gap: '8px' }}>
        {['document.pdf', 'image.jpg', 'video.mp4', 'presentation.pptx'].map((file) => (
          <div 
            key={file}
            style={{ 
              display: 'flex', 
